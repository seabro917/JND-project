% Testing algorithm with further bitrate checking, where empirical CDF and ground truth
% bitrate data were used for finding the ground truth QP.
function [QP_based_on_ECDF, searching_level] = Main_function_ECDF_ground_truth_checking(N,video_index,SUR_value,Bitrate_condition)
% Main function
